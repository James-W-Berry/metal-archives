...
public class SpotifyActivity extends Activity implements
    ...
    private static final String CLIENT_ID = "99812c99f64346d3acfcd606dc9b7d86";
    @SuppressWarnings("SpellCheckingInspection")
    private static final String REDIRECT_URI = "metal-archives-login://callback";

    @SuppressWarnings("SpellCheckingInspection")
    private static final String TEST_SONG_URI = "spotify:track:1Kfbxajn0CGtmUXGI2vsCQ";
    @SuppressWarnings("SpellCheckingInspection")
        ...
        if (mPlayer == null) {
            ...
            mPlayer = Spotify.getPlayer(playerConfig, this, new SpotifyPlayer.InitializationObserver() {
                ...
                public void onInitialized(SpotifyPlayer player) {
                    ...
                    mPlayer.setConnectivityStatus(mOperationCallback, getNetworkConnectivity(SpotifyActivity.this));
                    mPlayer.addNotificationCallback(SpotifyActivity.this);
                    mPlayer.addConnectionStateCallback(SpotifyActivity.this);
                    // Trigger UI refresh
                    updateView();
    ...
    protected void onPause() {
        ...
        // paused.
        if (mPlayer != null) {
            mPlayer.removeNotificationCallback(SpotifyActivity.this);
            mPlayer.removeConnectionStateCallback(SpotifyActivity.this);
        }
    }
